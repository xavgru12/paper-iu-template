...
\begin{document}
  ...
  \begin{tikzpicture}%[every node/.style={rectangle,draw,text width=14em,align=center}]
    ...
    \node[op4, below=of class] (init) {C-Platform Konfiguration};
    \node[op4, below=of init] (list) {Dateien von TPT analysieren};
...
%    \node[cn2, below=of list] (cond1) {};
    ...
    \node[op4, below=of depnewlist] (execution) {Execution Configuration};
